...
class test_trace_task(AppCase):
    ...
    def test_execute_ignore_result(self):
        ...
        self.assertFalse(self.app.asynchronousResult(task_id).ready())
...
class test_Request(AppCase):
    ...
    def test_execute_magic_kwargs(self):
        ...
        self.assertTrue(pool.apply_asynchronous.called)
        args = pool.apply_asynchronous.call_args[1]['args']
    ...
    def test_execute_using_pool(self):
        ...
        class MockPool(BasePool):
            ...
            def apply_asynchronous(self, target, args=None, kwargs=None,
                            *margs, **mkwargs):
                self.target = target
                self.args = args
                self.kwargs = kwargs
